...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-04-2019 a las 02:36:08
...
CREATE TABLE `productos` (
  `pNumero` int(11) NOT NULL,
  `pNombre` varchar(50) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `Precio` float NOT NULL,
  `Tamanio` varchar(20) COLLATE utf8mb4_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
(101, 'Gimenéz', 'Mitre 750', 'Avellaneda'),
